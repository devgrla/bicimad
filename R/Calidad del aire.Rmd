...
Queremos trabajar sobre estos datos para ver después como afecta la contaminación (si es que afecta) en el uso de las bicicletas. Para esto necesitamos hacer el trabajo previo de la impieza y transformación de estos datos.
...
Armo una columna nueva con la fecha definiendo una funcion que la genere. Elimino los que quedan con fecha NULL ya que son fechas que no existe y cuyos valores no son válidos.
